...
import mos.kos.cache.tool.UToast;

public class IflytekActivity extends BaseActivity {
    ...
    protected int layout() {
        ...
        return R.layout.activity_iflytek;
    }
    ...
    private boolean isShowDialog;//是否显示对话框

    private void toast(String str) {
        UToast.init().CustomShort(str);
    }
    ...
    protected void action(int ids) {
        if (null == mIat) {
            ...
            toast("创建对象失败，请确认 libmsc.so 放置正确，且有调用 createUtility 进行初始化");
            return;
        }
        switch (ids) {
            case R.id.image_iat_set:// 进入参数设置页面:
                toast("进入参数设置页面");
//                Intent intents = new Intent(this, IatSettings.class);
//                startActivity(intents);
                break;
            case R.id.iat_recognize://开始听写
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            ULog.d("SpeechRecognizer init() code = " + code);
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            ULog.d(results.getResultString());
            if (mTranslateEnable) {
